...
public class MovieActivity extends AppCompatActivity {
    ...
    //Add RecyclerView support library to the Gradle build file     -check
    //Define a model class to use as the data source                 -check
    //Add a RecyclerView to your activity to display the items       -check
    //Create a custom row layout XML file to visualize the item      -check
    //Create a RecyclerView.Adapter and ViewHolder to render the item -check
