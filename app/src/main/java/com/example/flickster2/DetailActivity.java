...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY ="AIzaSyDJ1y23yNfbIG2h54OXspWErUd9B-zWZAM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      movie=(Movie) Parcels.unwrap(getIntent().getParcelableExtra("movie"));
        ...
        client.get(String.format(TRAILERS_API,movie.getMovieId()),
    ...
    private void initializeYoutube(final String youtubekey) {
        youTubeplayerView.initialize(YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                Log.d("everythings fine","on init succes");
                youTubePlayer.cueVideo(youtubekey);
            }

            @Override
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Log.d("got to troubleshoot","on init failure");
            }
        });
    }
}
